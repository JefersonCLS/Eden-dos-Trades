...
void UpdateDashboard()
{
   ...
   GetPeriodStats(seteDiasAtras, 1, plSemanaTotal, winSemanaTotal, lossSemanaTotal); // Hack para pegar últimos 7 dias
   // Nota: Para precisão absoluta de "Semana Calendário", seria necessário ajustar o MqlDateTime, 
   // mas a lógica de 7 dias é visualmente suficiente para o trader.
